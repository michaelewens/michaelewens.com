      ...
      <main className="pt-32 pb-20 px-6 container mx-auto max-w-4xl">
        ...
        <div className="border-t border-border pt-10 mb-10">
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground leading-relaxed">"<a href="https://onlinelibrary.wiley.com/doi/10.1111/jofi.13451" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Venture Capital and Startup Agglomeration</a>", 2025, <span className="italic">Journal of Finance</span> (with Jun Chen)</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://osf.io/preprints/socarxiv/t96yq/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Board Dynamics over the Startup Lifecycle</a>", 2024 Forthcoming, <span className="italic">Journal of Finance</span> (with Nadya Malenko)</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://onlinelibrary.wiley.com/doi/10.1111/jofi.13383" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Founder-CEO Compensation and Selection into Venture Capital-Backed Entrepreneurship</a>" (with Ramana Nanda and Christopher Stanton), <span className="italic">The Journal of Finance</span> 79.5 (2024): 3361-3405.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://www.sciencedirect.com/science/article/abs/pii/S0304405X23002155" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Regulatory Costs of Being Public: Evidence from Bunching Estimation</a>", 2024, <span className="italic">Journal of Financial Economics</span>, 153 (with Kairong Xiao and Ting Xu)</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://pubsonline.informs.org/doi/10.1287/mnsc.2021.02058" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Measuring Intangible Capital with Market Prices</a>", (with Ryan Peters and Sean Wang) <span className="italic">Management Science</span> 71.1 (2024): 407-427.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://www.sciencedirect.com/science/chapter/handbook/abs/pii/S2949964X23000061" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Race and Gender in Entrepreneurial Finance</a>" (prepared for the <span className="italic">Handbook of the Economics of Corporate Finance, Private Equity and Entrepreneurial Finance</span> (Vol. 1), Editors Espen Eckbo, Gordon Phillips and Morten Sorensen)</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://www.annualreviews.org/content/journals/10.1146/annurev-financial-101821-121115" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Private or Public Equity? The Evolving Entrepreneurial Finance Landscape</a>" (with Joan Farre-Mensa) <span className="italic">Annual Review of Financial Economics</span> 2022 14:1, 271-293.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://www.sciencedirect.com/science/article/abs/pii/S0304405X21003123?via%3Dihub" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Venture Capital Contracts</a>" (with Alexander Gorbenko and Arthur Korteweg) <span className="italic">Journal of Financial Economics</span> 143.1 (2022):131–158.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://academic.oup.com/rfs/advance-article-abstract/doi/10.1093/rfs/hhaa053/5835291" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">The Deregulation of the Private Equity Markets and the Decline in IPOs</a>" (with Joan Farre-Mensa), <span className="italic">Review of Financial Studies</span> 33(12): 5463–5509. [Editor’s Choice]</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://www.sciencedirect.com/science/article/abs/pii/S0304405X19301758" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Are Early Stage Investors Biased Against Women?</a>" (with Richard Townsend) <span className="italic">Journal of Financial Economics</span> 135.3 (2020):653–677.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://www.sciencedirect.com/science/article/abs/pii/S0304405X18300631" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Cost of Experimentation and the Evolution of Venture Capital</a>" (with Ramana Nanda and Matthew Rhodes-Kropf) <span className="italic">Journal of Financial Economics</span> 128.3 (2018): 422-442.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="https://academic.oup.com/rfs/article-abstract/31/4/1532/4604800" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Founder Replacement and Startup Performance</a>" (with Matt Marx) <span className="italic">Review of Financial Studies</span> 31.4 (2018): 1532–1565.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="http://pubsonline.informs.org/doi/full/10.1287/mnsc.2016.2662" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Managing Performance Signals Through Delay: Evidence From Venture Capital Fundraising</a>" (with Indraneel Chakraborty) <span className="italic">Management Science</span> 64.6 (2017): 2875-2900.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="http://onlinelibrary.wiley.com/doi/10.1111/jofi.12249/abstract" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Is the VC Partnership More than the Sum of its Partners?</a>" (with M. Rhodes-Kropf) <span className="italic">Journal of Finance</span> 70.3 (2015): 1081-1114.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="http://www.mitpressjournals.org/doi/abs/10.1162/REST_a_00365" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Statistical Discrimination or Racial Prejudice? A Large Sample Field Study</a>" (with Bryan Tomlin and Liang Wang) <span className="italic">Review of Economics and Statistics</span> 96.1 (2014): 119-134.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="http://rfs.oxfordjournals.org/content/26/8/1854.abstract" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">The Price of Diversifiable Risk in Venture Capital and Private Equity</a>" (with Charles Jones and Matthew Rhodes-Kropf) <span className="italic">Review of Financial Studies</span> 26.8 (2013): 1854-1889.</p>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-10 mb-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">"<a href="https://osf.io/preprints/socarxiv/6ynf4" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Local Journalism Under Private Equity Ownership</a>", 2023 Revise & resubmit, <span className="italic">Review of Financial Studies</span> (with Arpit Gupta and Sabrina Howell)</p>
