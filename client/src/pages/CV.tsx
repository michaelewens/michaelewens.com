      ...
      <main className="pt-32 pb-20 px-6 container mx-auto max-w-4xl">
        ...
        <div className="border-t border-border pt-10 mb-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">"<a href="https://osf.io/preprints/socarxiv/t96yq/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Board Dynamics over the Startup Life Cycle</a>", 2024 Forthcoming, <span className="italic">Journal of Finance</span> (with Nadya Malenko)</p>
            ...
            <p className="text-muted-foreground leading-relaxed">"<a href="http://pubsonline.informs.org/doi/full/10.1287/mnsc.2016.2662" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Managing Performance Signals Through Delay: Evidence from Venture Capital</a>" (with Indraneel Chakraborty) <span className="italic">Management Science</span> 64.6 (2017): 2875-2900.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="http://onlinelibrary.wiley.com/doi/10.1111/jofi.12249/abstract" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Is a VC Partnership Greater than the Sum of its Partners?</a>" (with M. Rhodes-Kropf) <span className="italic">Journal of Finance</span> 70.3 (2015): 1081-1114.</p>
            <p className="text-muted-foreground leading-relaxed">"<a href="http://www.mitpressjournals.org/doi/abs/10.1162/REST_a_00365" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Statistical Discrimination or Prejudice? A Large Sample Field Experiment</a>" (with Bryan Tomlin and Liang Wang) <span className="italic">Review of Economics and Statistics</span> 96.1 (2014): 119-134.</p>
